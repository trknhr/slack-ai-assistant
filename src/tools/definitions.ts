export const customToolDefinitions = [
  ...
  },
  {
    ...
    description:
      "List assistant-generated Slack scheduled reminders for this workspace. These control when the assistant posts recurring notifications, not which duties appear inside a reminder.",
    input_schema: {
      type: "object",
      properties: {
        enabled: { type: "boolean" },
  ...
  },
  {
    ...
    description:
      "Create a recurring Slack notification generated by the assistant, such as a daily morning task reminder. Use this for the notification schedule itself; use upsert_recurring_task for the duties listed inside reminders.",
    input_schema: {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    description:
      "Update a recurring Slack notification generated by the assistant, including its name, prompt, output channel, enabled state, or delivery schedule.",
    input_schema: {
      type: "object",
      properties: {
        scheduled_task_id: { type: "string" },
  ...
  },
  {
    ...
    description: "Delete a recurring Slack notification generated by the assistant and remove its scheduler trigger.",
    input_schema: {
      type: "object",
      properties: {
        scheduled_task_id: { type: "string" },
